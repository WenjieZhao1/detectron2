...
__all__ = ["load_voc_instances", "get_OE_offline"]
...
for d in ["train", "val"]:
    DatasetCatalog.register("OOD" + d, lambda d=d: get_OE_offline("/people/cs/w/wxz220013/OOD/meta-ood/COCO/annotations"))
    MetadataCatalog.get("OOD" + d).set(thing_classes=["OOD"])
